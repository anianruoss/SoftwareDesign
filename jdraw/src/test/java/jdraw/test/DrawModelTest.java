...
public class DrawModelTest {
    ...
    public void testAddFigure1() {
        m.addFigure(f);
        assertEquals("get back the Figure from the model", (m.getFigures().iterator().next()), f);
    }
    ...
    public void testAddFigure5() {
        ...
        m.addFigure(f);
        assertEquals("no notification if figure is already contained in model", 0, cnt);
    }
    ...
    public void testRemoveFigure1() {
        m.addModelChangeListener(e -> cnt++);
        m.removeFigure(f);
        assertEquals("no notification expected, figure was not contained in model", 0, cnt);
    }
    ...
    public void testRemoveFigure2() {
        ...
        m.addFigure(f);
        m.removeFigure(f);
        assertEquals("listeners registered by the model must be removed", 0, cnt);
    }
    ...
    public void testRemoveFigure3() {
        ...
        m.addFigure(f);
        m.removeFigure(f);
        assertEquals("listeners registered by the model must be removed", 2, listeners.size());
        assertSame("the listener which has been registered must also be removed", listeners.get(0), listeners.get(1));
    }
    ...
    public void testRemoveFigure4() {
        ...
        m.removeFigure(f1);
        m.removeFigure(f2);
        assertEquals("listeners registered by the model must be removed", 4, listeners.size());
        assertSame("the listener which has been registered must also be removed", listeners.get(0), listeners.get(2));
        assertSame("the listener which has been registered must also be removed", listeners.get(1), listeners.get(3));
    }
